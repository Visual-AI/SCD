...
def parse_out_file(path, rx_dict, root_dir=save_root_dir, save_name='test.pkl', save=True, verbose=True):
    ...
    for i, line in enumerate(file):
        if line.find('Namespace') != -1:
            ...
            # model['wd'] = rx_dict['wd'].search(line).group(1)
            # model['Sup Con Weight'] = rx_dict['sc_weight'].search(line).group(1)
            # model['consistency_weight'] = rx_dict['consistency_weight'].search(line).group(1)
...
# base_path = '/work/sagar/osr_novel_categories/dev_outputs/logfile_{}.out'

# all_paths = [base_path.format(i) for i in ['407814_{}'.format(j) for j in range(11)]]
# all_paths = [base_path.format(i) for i in list(range(187, 193))] + [
#     '/work/sagar/osr_novel_categories/slurm_outputs/myLog-400861_0.out',
#     '/work/sagar/osr_novel_categories/slurm_outputs/myLog-400861_3.out'
# ]

# Ours Old
# all_paths = [base_path.format(i) for i in ['400654_0']]

# UNO Old vs New Comparison
# all_paths = [base_path.format(i) for i in [398150,
#                                            398156,
#                                            398155,
#                                            397550,
#                                            398153,
...
# AutoNovel Old vs New Comparison
# all_paths = [base_path.format(i) for i in [397532,
#                                            397533,
#                                            397534,
#                                            397535,
#                                            397536,
...
#                                            418036,
#                                            416528]]
# all_paths += ['/work/sagar/osr_novel_categories/dev_outputs/logfile_{}.out'.format(243)]

# all_paths = [base_path.format(i) for i in [447415,
#                                            447414,
#                                            447416,
#                                            447417,
#                                            447410,
...
all_paths = [base_path.format(i) for i in [448904,
                                           448905,
                                           448906,
                                           448907
                                           ]]
