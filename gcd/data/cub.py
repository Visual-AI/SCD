...
cub_root = '/disk/work/xhhuang/scd_v1/language_ncd_yandong/datasets/cubs'
...
class CustomCub2011(Dataset):
    ...
    def _load_metadata(self):
        ...
        self.classnames = [line.split()[1] for line in open(os.path.join(self.root,'CUB_200_2011',  'classes.txt'),'r')]
    ...
    def __getitem__(self, idx):
        ...
        # comment by yandong for ssb setting
