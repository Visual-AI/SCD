...
from data.imagenet import get_imagenet_1000_datasets
from data.imagenet import get_imagenet_127_datasets
from data.cub import get_cub_datasets
from data.fgvc_aircraft import get_aircraft_datasets
from data.stanford_dogs import get_sdogs_datasets
...
from data.stanford_dogs import subsample_classes as subsample_dataset_sdogs
...
osr_split_dir = 'Your_data_root/ssb_splits'
...
get_dataset_funcs = {
    ...
    'imagenet_1000': get_imagenet_1000_datasets,
    'imagenet_127': get_imagenet_127_datasets,
    'herbarium_19': get_herbarium_datasets,
    'cub': get_cub_datasets,
    'aircraft': get_aircraft_datasets,
    'scars': get_scars_datasets,
    'sdogs': get_sdogs_datasets
}
...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    def target_transform(x):
        ...
        if x not in target_transform_dict.keys():
            debug = 0
    ...
    for dataset_name, dataset in datasets.items():
        if dataset is not None and dataset_name in ['train_labelled', 'train_unlabelled', 'val', 'test']:
...
def get_class_splits(args):
    ...
    elif args.dataset_name == 'imagenet_1000':

        args.image_size = 224
        args.train_classes = range(500)
        args.unlabeled_classes = range(500, 1000)

    elif args.dataset_name == 'imagenet_127':

        args.image_size = 224
        args.train_classes = range(64)
        args.unlabeled_classes = range(64, 127)
